...
import com.veracity.data.shared_preferences.AppSharedPreferences;
import com.veracity.ui.splash_screen.SplashScreenActivity;
import com.veracity.widgets.blurimage.Blur;
...
import static com.veracity.app.AppConstants.ONE;
import static com.veracity.app.AppConstants.ZERO;
...
//        dialog.getWindow().setAttributes(layoutParams);
    ...
    protected void cameraIntent(){
        ...
        try {
            ...
            intent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(getActivity(), "com.veracity", f));
