...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_address_map);
    ...
    private void initMapsAndPlaces() {
        ...
        if (mApiKey != null && !TextUtils.isEmpty(mApiKey))
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        fabFindMyLocation.setOnClickListener(v -> initMapsAndPlaces());
...
//                ToDo : you can use retrofit for this network call instead of using services
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mLAstKnownLocation != null) {
                                LatLng coordinate = new LatLng(mLAstKnownLocation.getLatitude(), mLAstKnownLocation.getLongitude()); //Store these lat lng values somewhere. These should be constant.
                                CameraUpdate location = CameraUpdateFactory.newLatLngZoom(coordinate, DEFAULT_ZOOM);
                                mMap.animateCamera(location);
    ...
    private void showRippleAnimationToMarker() {
