...
public interface ApiInterface {
    ...
    Single<com.poona.agrocart.data.network.responses.help_center_response.SendMessageResponse> getSenderMessage(@FieldMap HashMap<String, String> sendMessageParameters);;
}