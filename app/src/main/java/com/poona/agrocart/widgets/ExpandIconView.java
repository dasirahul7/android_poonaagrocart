...
public class ExpandIconView extends View {
    ...
    public ExpandIconView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            color = array.getColor(R.styleable.ExpandIconView_eiv_color, ContextCompat.getColor(getContext(), R.color.white));
            colorMore = array.getColor(R.styleable.ExpandIconView_eiv_colorMore, ContextCompat.getColor(getContext(), R.color.white));
            colorLess = array.getColor(R.styleable.ExpandIconView_eiv_colorLess, ContextCompat.getColor(getContext(), R.color.white));
